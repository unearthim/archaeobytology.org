# Simple Markdown to HTML Converter for 300-Institution-Building Course Modules

Write-Host "Converting module files to HTML..." -ForegroundColor Cyan

# Get all module markdown files
$files = Get-ChildItem -Filter "300-Module-*.md" | Sort-Object Name
Write-Host "Found $($files.Count) module files" -ForegroundColor Green
...
<head>
    ...
    <title>$title | ARCH 300: Institution Building</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .container { max-width: 900px; margin: 0 auto; background: #FFFFFF; padding: 3rem; border-radius: 15px; box-shadow: 0 4px 20px rgba(46,46,46,0.1); border: 1px solid #D1D1D1; }
        ...
        code { font-family: 'Courier New', monospace; background: #F8F7F4; padding: 0.2rem 0.4rem; border-radius: 3px; border: 1px solid #D1D1D1; font-size: 0.95rem; }
...
Write-Host ""
Write-Host "✅ Converted $converted module files successfully!" -ForegroundColor Green
Write-Host "Open index.html to view the course home page" -ForegroundColor Cyan
